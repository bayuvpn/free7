...
#wget -O /etc/systemd/system/ws-openssh.service https://raw.githubusercontent.com/bayuvpn/free7/main/sshws/service-wsopenssh && chmod +x /etc/systemd/system/ws-openssh.service
